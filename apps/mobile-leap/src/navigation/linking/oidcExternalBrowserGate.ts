...
import { DEFAULT_APP_HOST } from './config'
 ...
 */
export function shouldOpenHyloOidcInExternalBrowser (providedPathOrURL: string): boolean {
  try {
...
export function hyloUrlForExternalBrowser (providedPathOrURL: string): string {
