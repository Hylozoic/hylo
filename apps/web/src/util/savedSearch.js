...
export function formatParams (search) {
  ...
  return [
    `Created on ${DateTimeHelpers.toDateTime(createdAt, { locale: localeLocalStorageSync() }).toFormat('MMMM d yyyy')}`, // this was 'do' as in ordinal, but not supported in luxon
