...
export const heyAxolotl = '/assets/hey-axolotl.png'
export const puzzledAxolotl = '/assets/puzzled-axolotl.jpg'
export const mapIconAtlas = '/mapIconAtlas.png'
export const explorerBannerSvg = '/group-explorer-hero.svg'
