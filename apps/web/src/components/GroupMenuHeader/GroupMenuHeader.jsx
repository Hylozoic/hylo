    ...
    >
      ...
      >
        ...
        <div className={cn(`flex flex-col text-${textColor} drop-shadow-md overflow-hidden`, compact && centered ? 'flex-none max-w-[60%]' : 'flex-1')}>
          ...
          >
            <Link
              className='inline-flex items-center gap-1 rounded-full bg-black/40 backdrop-blur-sm border border-white/20 px-2 py-0.5 text-white hover:bg-black/60 hover:text-white no-underline hover:no-underline transition-colors'
            ...
            <span className='inline-flex' data-tour='group-invite'>
              <InviteMembersDialog
                ...
                triggerClassName='rounded-full bg-black/40 backdrop-blur-sm border border-white/20 px-2 py-0.5 text-white hover:text-white hover:bg-black/60 hover:scale-100'
              />
            </span>
            <button
              type='button'
              ...
              className='inline-flex items-center gap-1 rounded-full bg-black/40 backdrop-blur-sm border border-white/20 px-2 py-0.5 text-white hover:bg-black/60 hover:text-white transition-colors'
            >
