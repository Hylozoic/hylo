  ...
  return (
    <div
      className={cn(
        ...
        'bg-card hover:scale-102 transition-all hover:shadow-lg hover:shadow-foreground/10',
        'px-4 py-3 border-b-2 border-background cursor-pointer',
        {
    ...
    >
      ...
      <div className='flex flex-col min-w-0'>
        <span className={cn('text-base text-foreground truncate', { 'font-semibold': unread })}>
          {creator.name}
        </span>
      ...
      <div className='flex flex-col min-w-0 gap-0.5'>
        <div className='flex items-center gap-2'>
          ...
          <span className={cn('text-base text-foreground truncate font-bold', { 'font-semibold': unread })}>
            {title}
          </span>
          {commentsTotal > 0
            ? (
        ...
        {eventDateDisplay
          ...
          : (
            <HyloHTML
              className='-mt-4 text-xs text-foreground/50 line-clamp-1'
              html={details}
            />
            )}
      </div>
