...
class PostGroups extends Component {
  ...
  render () {
    ...
    return (
      <div className={cn('bg-darkening/10 p-2 mx-[8px] rounded-lg mt-2 mb-2', { [classes.constrained]: constrained, [classes.expanded]: expanded, [classes.bottomBorder]: showBottomBorder })} onClick={expanded ? this.toggleExpanded : undefined}>
