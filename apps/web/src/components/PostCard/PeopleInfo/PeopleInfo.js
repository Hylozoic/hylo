...
export default function PeopleInfo ({
  ...
  return (
    <div className={cn('flex items-center bg-black/10 gap-2 px-3 rounded-lg hover:bg-black/30 transition-all', classes.peopleContainer, { [classes.constrained]: constrained }, className)}>
