  ...
  return (
    <>
      ...
      <div
        ref={postCardRef}
        className={cn(
          'PostCard rounded-xl cursor-pointer relative flex flex-col transition-all duration-250 bg-card/40 border-2 border-card/30 shadow-md hover:shadow-lg mb-4 hover:scale-105 duration-300 delay-200',
          classes[postType],
