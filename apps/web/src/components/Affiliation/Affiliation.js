...
export default function Affiliation ({ affiliation, index, archive }) {
  ...
  return (
    <div className={cn('rounded-lg bg-black/10 flex transition-all text-foreground items-center align-center px-5 h-[40px] opacity-80 hover:opacity-100 scale-100 hover:scale-105 hover:bg-black/20 flex gap-1 ', index % 2 === 0 ? 'bg-black/5' : 'bg-black/10')} >
