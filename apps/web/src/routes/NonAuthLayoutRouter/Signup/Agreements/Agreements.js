...
export default function Agreements () {
  ...
  return (
    <div className='bg-background/100 shadow-md rounded-md w-[320px] md:w-[640px] max-h-[70vh] flex flex-col mt-20'>
      ...
      <div className='p-6 border-t border-foreground/10 bg-background/100 rounded-b-md'>
