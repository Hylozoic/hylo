    ...
    <div className={classes.joinRequest}>
      <div className={classes.invitationDetail}>
        ...
        <div className={classes.invitationResponse}>
          <span className={classes.createdDate}>{t('Sent')} {DateTimeHelpers.toDateTime(createdAt, { locale: localeLocalStorageSync() }).toFormat('MM-dd-yyyy')}</span>
  ...
  return (
    <div className={classes.joinRequest}>
      ...
      <div className={classes.requestDetail}>
        <span className={`${classes.createdDate} ${classes.joinRequestDate}`}>{t('Requested')} {DateTimeHelpers.toDateTime(createdAt, { locale: localeLocalStorageSync() }).toFormat('yyyy-MM-dd')}</span>
