        ...
        <div className='relative flex flex-col items-center overflow-hidden z-20'>
          <div className='w-full'>
            <ul className='m-0 p-3 mb-6'>
              <li>
                <div>
                  <h3 className='text-base font-light opacity-50 text-foreground mb-2 uppercase'>{t('Platform')}</h3>
                  <ul className='p-0'>
                    <li>
                      <MenuLink
                        to='/management/platform/health'
                        className={cn(
                          ...
                          { 'border-secondary': location.pathname === '/management/platform/health' }
                        )}
                      >
                        {t('Health')}
                      </MenuLink>
              ...
              <li>
                <div>
                  <h3 className='text-base font-light opacity-50 text-foreground mb-2 mt-4'>SITE</h3>
                  <ul className='p-0'>
                    <li>
                      <MenuLink
