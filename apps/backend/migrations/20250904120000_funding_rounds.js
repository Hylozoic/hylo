exports.up = async function (knex) {
  await knex.schema.createTable('funding_rounds', table => {
    ...
    table.timestamp('voting_open_at')
    table.timestamp('voting_close_at')
    table.string('submissions_descriptor')
    table.string('submissions_descriptor_plural')
    table.bigInteger('submission_role_id')
    table.string('submission_role_type')
    table.bigInteger('voting_role_id')
    table.string('voting_role_type')
