exports.es = {
  ...
  moderationClearedPostEmailContent: ({ post, group }) => `Tu publicación "${post.title()}" en el grupo ${group.get('name')} fue eliminada por violar un acuerdo de grupo. \n`,
  moderationClearedYourFlag: () => 'El moderador eliminó tu denuncia',
  moderationFlaggedPostEmailContent: ({ post, group }) => `Tu publicación "${post.title()}" en el grupo ${group.get('name')} fue denunciada como violando un acuerdo de grupo. \n`,
  moderationReporterClearedPostEmailContent: ({ post, group }) => `La publicación "${post.title()}" en el grupo ${group.get('name')} que denunciaste fue eliminada por violar un acuerdo de grupo. \n`,
  moderationYouFlaggedAPost: () => 'Has denunciado una publicación',
  moderationYouFlaggedPostEmailContent: ({ post, group }) => `Has denunciado la publicación "${post.title()}" en el grupo ${group.get('name')} como violando un acuerdo de grupo. \n`,
