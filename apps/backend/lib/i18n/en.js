exports.en = {
  ...
  moderationClearedPostEmailContent: ({ post, group }) => `Your post "${post.title()}" in group ${group.get('name')} was cleared of a group agreement violation. \n`,
  moderationClearedYourFlag: () => 'Moderator cleared your flag',
  moderationFlaggedPostEmailContent: ({ post, group }) => `Your post "${post.title()}" in group ${group.get('name')} was flagged as violating a group agreement. \n`,
  moderationReporterClearedPostEmailContent: ({ post, group }) => `The post "${post.title()}" in group ${group.get('name')} that you flagged was cleared of a group agreement violation. \n`,
  moderationYouFlaggedAPost: () => 'You flagged a post',
  moderationYouFlaggedPostEmailContent: ({ post, group }) => `You flagged post "${post.title()}" in group ${group.get('name')} as violating a group agreement. \n`,
