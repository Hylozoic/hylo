...
// '/groups/:groupSlug/post/:postId?commentId=:commentId',
...
const notificationsSamplePaths = [
  ...
  '/groups/example-group/post/123?commentId=456',
  '/groups/example-group/stream/post/123?commentId=456',
  '/groups/example-group/chat/general/post/123?commentId=456',
  '/groups/example-group/stream/post/123?commentId=456',
  '/h/use-invitation',
  '/login',
  '/members/789',
