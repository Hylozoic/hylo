...
export const routingConfig = {
  ...
  '/:groupSlug(all)/chat/:topicName':                        `${AUTH_ROOT_SCREEN_NAME}/Drawer/Tabs/Home Tab/Stream`,
  ...
  '/:context(groups)/:groupSlug/chat/:topicName':            `${AUTH_ROOT_SCREEN_NAME}/Drawer/Tabs/Home Tab/Chat`,
