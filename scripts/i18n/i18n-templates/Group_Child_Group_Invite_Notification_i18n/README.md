# Group Child Group Invite Notification_i18n

**Template ID**: `tem_7tcVCp6WrxFSRRt9qxfmMm9K`  
**Version ID**: `ver_g3mHPFGSDq4pHTGqYh9Hcfh8`  
**Version Name**: New Version  
**Locale**: en-US  
**Downloaded**: 2026-01-29T01:25:35.517Z

## Subject

\`\`\`liquid
{% trans %}{{child_group_name}} has been invited to join {{parent_group_name}}{% endtrans %}
\`\`\`
...
<p>
{{actor_pill(inviter_name, inviter_avatar_url, inviter_profile_url)}} {% trans %}has invited{% endtrans %} {{actor_pill(child_group_name, child_group_avatar_url, child_group_settings_url)}} {% trans %}to be a part of{% endtrans %} {{actor_pill(parent_group_name, parent_group_avatar_url, parent_group_url)}}
</p>

<p>{% trans %}When your group becomes a part of another group, your members will be able to join that group.{% endtrans %}</p>  
